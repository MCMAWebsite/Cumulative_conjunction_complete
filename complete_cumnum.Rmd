...
all_conjs = readRDS(paste0(user_website, "/RDSfiles/all_conjs"))
all_conjs_expanded = readRDS(paste0(user_website, "/RDSfiles/all_conjs_expanded"))
derelicts = readRDS(paste0(user_website, "/RDSfiles/derelicts"))
derelictDat = readRDS(paste0(user_website, "/RDSfiles/derelictDatNew"))
alt_bins = readRDS(paste0(user_website, "/RDSfiles/alt_bins"))
file_list = readRDS(paste0(user_website, "/RDSfiles/file_list"))
all_conjs_2016 = readRDS(paste0(user_website, "/RDSfiles/all_conjs_2016"))
